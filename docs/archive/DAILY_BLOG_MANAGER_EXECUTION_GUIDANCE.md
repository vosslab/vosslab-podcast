...
Use this guidance with [DAILY_BLOG_PIPELINE_FIXUP_PLAN.md](DAILY_BLOG_PIPELINE_FIXUP_PLAN.md)
and [BETTER_PROMPT_PLAN.md](BETTER_PROMPT_PLAN.md). Build a working,
...
[BETTER_PROMPT_PLAN.md](BETTER_PROMPT_PLAN.md).
